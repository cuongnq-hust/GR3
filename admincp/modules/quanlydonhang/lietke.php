  ...
  ?>
    <tr>
      ...
      <td><?php if ($row['cart_status'] == 1) {
            echo '<a href="modules/quanlydonhang/xuly.php?code=' . $row['code_cart'] . '">Don Hang Moi</a>';
          } else {
            echo 'Da xem';
          } ?></td>
      ...
      <td>
        <a href="modules/quanlydonhang/indonhang.php?code=<?php echo $row['code_cart'] ?>">In Don Hang</a>
      </td>
    </tr>
  <?php
  }
