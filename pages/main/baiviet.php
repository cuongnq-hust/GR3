...
?>
<h3>Bai Viet : <span style="text-align: center; text-transform: uppercase"><?php echo $row_bv_title['tenbaiviet'] ?></span></h3>
<ul class="baiviet">
    <?php
    ...
    ?>
        <li>
            ...
            <p style="text-align: center;" class="title_product"> <?php echo $row_bv['noidung'] ?></p>
        </li>
    <?php
    }
    ?>
